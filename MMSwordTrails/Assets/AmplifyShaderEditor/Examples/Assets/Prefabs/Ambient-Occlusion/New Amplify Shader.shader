	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float simplePerlin2D7 = snoise( float2( 0,0 ) );
				simplePerlin2D7 = simplePerlin2D7*0.5 + 0.5;
				float3 temp_cast_0 = (simplePerlin2D7).xxx;
...
/*ASEBEGIN
Version=18910
349;350;1299;546;727.6343;349.6438;1;True;True
Node;AmplifyShaderEditor.NoiseGeneratorNode;7;-328.9399,-29.98669;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
